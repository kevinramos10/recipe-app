...
const CardRecipe = ({nombre, categoria, imagen} : CardRecipeProps) => {
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <button className="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded-lg transition-colors cursor-pointer mt-auto">
          Ver info
        </button>
      </div>
    </div>
